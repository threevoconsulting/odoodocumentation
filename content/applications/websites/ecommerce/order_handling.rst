...
.. note::
   - The :doc:`Inventory app </applications/inventory_and_mrp/inventory>` must be installed to process
     deliveries.
...
.. tip::
   ...
   :guilabel:`Shipping` section, and enable :guilabel:`Email Confirmation`.
