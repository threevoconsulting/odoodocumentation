...
To display a discount label on a Pricer Tag, you need to link a :ref:`pricelist
<pos/pricing/pricelists>` to the product variant associated with the tag.
